#include <iostream>  // This header file contains all C++ libraries
#include <vector>
#include <algorithm>
...
int main()
{
    ...
    /*Training Phase*/
    for (int i = 0; i < 20; i ++) {   // Since there are five övalues and four epochs are needed, run a for loop 20 times.
